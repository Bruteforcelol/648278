...
local Library = {
    ...
    Scheme = {
        ...
        AccentColor = Color3.fromRGB(0, 201, 255), -- cyan accent
        Red = Color3.fromRGB(255, 79, 62),
        ToggleColor = Color3.fromRGB(0, 160, 200),
        Hue = 0,
    },
...
--// Loading screen (added by patch): simple cyan on obsidian panel
...
New("UICorner", { CornerRadius = UDim.new(0, Library.CornerRadius), Parent = LoadingPanel })
New("UIStroke", { Color = "OutlineColor", Parent = LoadingPanel })
New("UIPadding", { PaddingLeft = UDim.new(0, 12), PaddingRight = UDim.new(0, 12), PaddingTop = UDim.new(0, 12), PaddingBottom = UDim.new(0, 12), Parent = LoadingPanel })
...
New("UIListLayout", { Padding = UDim.new(0, 6), Parent = LoadingPanel })

function Library:ShowLoading(Show)
    if not LoadingFrame then return end
    LoadingFrame.Visible = not not Show
end
